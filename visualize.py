...
def main():
    ...
    # algo_list.append({
    #     'name': 'CVPO',
    #     'logs': [f'data.old/Safexp-PointGoal3-v0_cost_50/cvpo_epoch_1250_Trial{i}' for i in [1]]
    # })
    # draw(env_name, item_list, algo_list, fig_size, window_size, interp_steps, is_horizon=True)

    env_name = "PointButton"
    algo_list = []
    algo_list.append({
        'name': 'CVPO',
        'logs': [f'data/Safexp-PointButton3-v0_cost_50/cvpo_epoch_1250_Trial{i}' for i in [1]]
    })
    draw(env_name, item_list, algo_list, fig_size, window_size, interp_steps, is_horizon=True)
    ...
    algo_list.append({
        'name': 'CVPO',
        'logs': [f'data/Safexp-CarButton3-v0_cost_50/cvpo_epoch_1250_Trial{i}' for i in [1]]
    })
    draw(env_name, item_list, algo_list, fig_size, window_size, interp_steps, is_horizon=True)
